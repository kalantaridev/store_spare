...
@yield('select2_css')
@yield('import_for_table_user')
@yield('style_sweetalert2')
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="setting" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('contactUs.index')}}"> تنظیمات تماس با ما </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="categories" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('categories.create')}}">دسته بندی جدید </a>
                        </li>
                    </ul>
                </li>
